...
//Presentation Group Video link 
//https://www.youtube.com/watch?v=D_I3G0Xg0Ck
//

public class BudgetTrackerFinal {
	...
	public static void main(String[] args) {
		...
		int calen;
		Calendar cal;
		cale = JOptionPane.showInputDialog("Enter Month Number you want: ");
		...
		// JLabels
		JLabel dateL = new JLabel("Enter DayNumber");
		...
		dateL.setBounds(1050, 10, 125, 25);
